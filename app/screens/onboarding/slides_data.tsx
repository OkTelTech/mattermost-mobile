    ...
    const slidesData: OnboardingItem[] = [
        {
            ...
            description: intl.formatMessage({id: 'onboaring.welcome_description', defaultMessage: 'Oktel is a platform for team collaboration. Secure, flexible, and integrated with your tools.'}),
            image: chatSvg,
        },
        {
